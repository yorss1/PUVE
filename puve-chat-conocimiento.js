...
const BASE_CONOCIMIENTO_PUVE = [
  ...
  {
    "patrones": [
      "como retiro mi comision",
      "como pido mi dinero de embajador",
      "solicitar retiro embajador",
      "donde veo mi saldo de embajador",
      "cuando me pagan la comision"
    ],
    "respuesta": "En tu panel de Embajador, en \"Estado de cuenta\", toca \"Solicitar retiro\": ahí escribes el monto (hasta lo que tengas disponible), tu banco, el titular y la CLABE de 18 dígitos. Queda \"En trámite\" hasta que el equipo de PUVE haga el depósito y lo marque como pagado; ahí puedes ver el historial de todas tus solicitudes."
  },
  {
    "patrones": [
      "puedo pagar con tarjeta",
      "pago con tarjeta de credito",
      "como activo el cobro automatico",
      "suscripcion automatica",
      "se me cobra solo cada mes",
      "cancelar cobro automatico con tarjeta"
    ],
    "respuesta": "Sí. En la pantalla de pago tienes tres opciones: pagar con tarjeta una sola vez (como una transferencia, pero al instante), activar el cobro automático para que se te cargue solo cada periodo sin que tengas que volver a pagar, o seguir con transferencia bancaria manual. Si activaste el cobro automático, puedes cancelarlo cuando quieras desde Configuración → Mi plan — tu negocio sigue activo hasta que termine lo que ya pagaste.",
    "seccion": "config"
  },
  {
    "patrones": [
      "retiro automatico con stripe",
      "cuando me llega mi comision a mi cuenta",
      "conectar cuenta bancaria con stripe",
      "stripe embajador"
    ],
    "respuesta": "Como Embajador puedes conectar tu cuenta con Stripe (en tu panel, arriba de \"Solicitar retiro\"). Stripe te pide tus datos ahí mismo de forma segura — PUVE no los ve ni los guarda. Una vez conectada, tus retiros se pueden pagar al instante en lugar de esperar una transferencia manual; si no la conectas, tu retiro se sigue pagando por transferencia normal."
  }
];
